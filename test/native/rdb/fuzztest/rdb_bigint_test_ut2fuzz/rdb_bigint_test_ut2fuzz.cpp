 ...
 */
#include "rdb_bigint_test_ut2fuzz.h"
...
void BigIntegerFuzzTest(FuzzedDataProvider &fdp)
{
    ...
    auto bi1 = NativeRdb::BigInteger(fdp.ConsumeIntegral<int64_t>());
