...
public:
    ...
    MOCK_METHOD(int, SetDistributedInfo,
        (const DistributedRdb::DistributedInfo &distributedInfo, const SqlInfo &sqlInfo, const std::string &tableName,
            bool hasSpecificField),
        (override));
