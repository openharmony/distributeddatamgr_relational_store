...
HWTEST_F(GdbExecuteTest, GdbStore_Execute_UtilsConfigTest, TestSize.Level1)
{
    ...
    EXPECT_EQ(ret, R"({"pageSize": 8, "crcCheckEnable": 0, "defaultIsolationLevel": 3, )"
        R"("redoFlushByTrx": 1, "metaInfoBak": 1, "maxConnNum": 500, "bufferPoolSize": 10240})");
    
    ret = GdbUtils::GetConfigStr(keys, true);
    EXPECT_EQ(ret, R"({"isEncrypted":1,"hexPassword":"0102030405060708",)"
        R"("pageSize": 8, "crcCheckEnable": 0, "defaultIsolationLevel": 3, )"
        R"("redoFlushByTrx": 1, "metaInfoBak": 1, "maxConnNum": 500, "bufferPoolSize": 10240})");
}
