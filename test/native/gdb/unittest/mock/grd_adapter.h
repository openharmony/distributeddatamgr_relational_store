...
#ifndef OHOS_DISTRIBUTED_DATA_NATIVE_MOCK_GRD_ADAPTER_H
#define OHOS_DISTRIBUTED_DATA_NATIVE_MOCK_GRD_ADAPTER_H
...
public:
    ...
    static void SetErrorCode(FuncName func, int32_t err);
    ...
    static int32_t Rekey(const char *dbFile, const char *configStr, const std::vector<uint8_t> &encryptedKey);
...
private:
    ...
    static int32_t errorCode_[FuncName::ALL];
    static std::map<int32_t, int32_t> GRD_ERRNO_MAP;
};
}
#endif // OHOS_DISTRIBUTED_DATA_NATIVE_MOCK_GRD_ADAPTER_H
