...
describe('CloudConfigTest', function () {
    ...
    it('EnabledCloudInvalidArgsTest', 0, async function (done) {
        ...
        try {
            let account = "test_id";
            await ddm.Config.enableCloud(account, null).then((data) => {
    ...
    it('DisableCloudInvalidArgsTest', 0, async function (done) {
        ...
        try {
            await ddm.Config.disableCloud(null).then((data) => {
    ...
    it('DisableCloudInvalidArgsNumsTest', 0, async function (done) {
        ...
        try {
            await ddm.Config.disableCloud().then((data) => {
    ...
    it('ChangeAppCloudInvalidArgsTest', 0, async function (done) {
        ...
        try {
            ...
            await ddm.Config.changeAppCloudSwitch(account, bundleName, null).then((data) => {
    ...
    it('ChangeAppCloudInvalidArgsNumsTest', 0, async function (done) {
        ...
        try {
            let account = "test_id";
            let bundleName = "test_bundleName";
            await ddm.Config.changeAppCloudSwitch(account, bundleName).then((data) => {
    ...
    it('NotifyChangeInvalidArgsTest', 0, async function (done) {
        ...
        try {
            let account = "test_id";
            await ddm.Config.notifyDataChange(account, null).then((data) => {
    ...
    it('NotifyChangeInvalidArgsNumsTest', 0, async function (done) {
        ...
        try {
            let account = "test_id";
            await ddm.Config.notifyDataChange(account).then((data) => {
    ...
    it('CleanInvalidArgsNumsTest', 0, async function (done) {
        ...
        try {
            let con = ddm.Action;
            let account = "test_id";
            await ddm.Config.clean(account).then((data) => {
