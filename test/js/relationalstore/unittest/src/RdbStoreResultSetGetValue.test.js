...
describe('rdbStoreResultSetGetValueTest', function () {
  ...
  /**
   * @tc.name rdb store resultSet getValue test
   * @tc.number rdbStoreResultSetGetValueTest_0011
   * @tc.desc Insert a string greater than number.MAX_SAFE_INTEGER is also obtained as a string by getValue
   */
  it('rdbStoreResultSetGetValueTest_0011', 0, async function () {
    console.log(TAG + "************* rdbStoreResultSetGetValueTest_0011 start *************");
    ...
    try {
      let resultSet = await rdbStore.querySql('SELECT * FROM test')
      expect(true).assertEqual(resultSet.goToFirstRow());
      expect(valueNum).assertEqual(resultSet.getValue(resultSet.getColumnIndex('age')));
      resultSet.close();
    } catch (err) {
      console.error(`### query failed, code:${err.code}, message:${err.message}`)
    }
    console.log(TAG + "************* rdbStoreResultSetGetValueTest_0011 end   *************");
  })

  /**
   * @tc.name rdb store resultSet getValue test
   * @tc.number rdbStoreResultSetGetValueTest_0012
   * @tc.desc Insert as a string equal to number.MAX_SAFE_INTEGER, getValue obtains the number
   */
  it('rdbStoreResultSetGetValueTest_0012', 0, async function () {
    console.log(TAG + "************* rdbStoreResultSetGetValueTest_0012 start *************");
    ...
    try {
      let resultSet = await rdbStore.querySql('SELECT * FROM test')
      expect(true).assertEqual(resultSet.goToFirstRow());
      expect(Number.MAX_SAFE_INTEGER).assertEqual(resultSet.getValue(resultSet.getColumnIndex('age')));
      resultSet.close();
    } catch (err) {
      console.error(`### query failed, code:${err.code}, message:${err.message}`)
    }
    console.log(TAG + "************* rdbStoreResultSetGetValueTest_0012 end   *************");
  })
