...
describe('rdbStoreCustomTest', function () {
     ...
     * @tc.name Normal test case of deleteRdbStore, Configure customDir
     * @tc.desc 1.Configure customDir
     *          2.Execute getRdbStore
     ...
     *          2.Execute getRdbStore
     */
    it('testRdbStoreCustomDirTest00010', 0, async function (done) {
        console.info(TAG, "************* testRdbStoreCustomDirTest00010 start *************");
        try {
