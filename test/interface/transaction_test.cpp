...
class RdbInterfaceTransactionTest : public testing::Test {
public:
...
int RdbInterfaceTransactionTest::TransactionTestOpenCallback::OnCreate(RdbStore &store)
{
    auto [ret, value] = store.Execute(CREATE_TABLE_SQL);
    return ret;
}

int RdbInterfaceTransactionTest::TransactionTestOpenCallback::OnUpgrade(RdbStore &store, int oldVersion, int newVersion)
{
    return E_OK;
}

void RdbInterfaceTransactionTest::SetUpTestCase()
{
    int errCode = E_OK;
    RdbHelper::DeleteRdbStore(DATABASE_NAME);
    RdbStoreConfig config(DATABASE_NAME);
    TransactionTestOpenCallback helper;
    RdbInterfaceTransactionTest::store_ = RdbHelper::GetRdbStore(config, 1, helper, errCode);
    ASSERT_NE(RdbInterfaceTransactionTest::store_, nullptr);
    ASSERT_EQ(errCode, E_OK);
}

void RdbInterfaceTransactionTest::TearDownTestCase()
{
    store_ = nullptr;
    RdbHelper::DeleteRdbStore(DATABASE_NAME);
}

void RdbInterfaceTransactionTest::SetUp()
{
    ASSERT_NE(store_, nullptr);
    store_->Execute("DELETE FROM test");
}

void RdbInterfaceTransactionTest::TearDown()
{
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_001, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_002, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_003, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    ...
    Transaction::Rows rows{
        RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[0]),
        RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[1]),
        RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[2]),
    };
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_004, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    ...
    rows.Put(RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[0]));
    rows.Put(RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[1]));
    rows.Put(RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[2]));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_005, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_006, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_007, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_008, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_009, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_010, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_011, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_012, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_013, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_014, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_015, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_016, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_017, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_018, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_019, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    store->Execute("DROP TABLE IF EXISTS test1");
    auto res = store->Execute("CREATE TABLE test1 (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)");
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_020, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_021, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    ...
    auto [err, rows] = transaction->Insert("test", RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[0]), Transaction::NO_ACTION);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_022, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_023, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_024, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_025, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    ...
    auto result = transaction->Update("test", RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[1]), "id=1");
    ASSERT_EQ(result.first, E_ALREADY_CLOSED);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_026, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
    ...
    AbsRdbPredicates predicates("test");
    predicates.EqualTo("id", ValueObject(2));
    auto result = transaction->Update(RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[2]), predicates);
    ASSERT_EQ(result.first, E_ALREADY_CLOSED);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_027, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_028, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_029, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_030, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_031, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_032, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_033, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_034, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_035, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_036, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_037, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_038, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_039, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_040, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_041, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_042, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_043, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_044, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_045, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_046, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_047, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_048, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_049, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_050, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_052, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_053, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_054, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_055, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_056, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_057, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_058, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_059, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_060, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_061, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_062, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceTransactionTest, RdbStore_Transaction_063, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceTransactionTest::store_;
