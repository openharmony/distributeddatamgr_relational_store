...
class RdbInterfaceExecuteRdTest : public testing::TestWithParam<bool> {
public:
...
INSTANTIATE_TEST_CASE_P(, RdbInterfaceExecuteRdTest, testing::Values(false, true));

const std::string RdbInterfaceExecuteRdTest::databaseName = RDB_TEST_PATH + "execute_test.db";
const std::string RdbInterfaceExecuteRdTest::restoreDatabaseName = RDB_TEST_PATH + "execute_test_restore.db";
const std::string RdbInterfaceExecuteRdTest::backupDatabaseName = RDB_TEST_PATH + "execute_test_backup.db";
std::shared_ptr<RdbStore> RdbInterfaceExecuteRdTest::store = nullptr;
...
void RdbInterfaceExecuteRdTest::SetUpTestCase(void)
{
}

void RdbInterfaceExecuteRdTest::TearDownTestCase(void)
{
}

void RdbInterfaceExecuteRdTest::SetUp(void)
{
    if (!IsUsingArkData()) {
        GTEST_SKIP() << "Current testcase is not compatible from current rdb";
    }
    int errCode = E_OK;
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::databaseName);
    RdbStoreConfig config(RdbInterfaceExecuteRdTest::databaseName);
    config.SetIsVector(true);
    config.SetEncryptStatus(GetParam());
    ExecuteTestOpenRdCallback helper;
    RdbInterfaceExecuteRdTest::store = RdbHelper::GetRdbStore(config, 1, helper, errCode);
    EXPECT_NE(RdbInterfaceExecuteRdTest::store, nullptr);
    EXPECT_EQ(errCode, E_OK);
}

void RdbInterfaceExecuteRdTest::TearDown(void)
{
    RdbInterfaceExecuteRdTest::store = nullptr;
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::databaseName);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_001, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_002, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_003, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_004, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_005, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
    std::string sqlCreateTable = "CREATE TABLE IF NOT EXISTS test (id INTEGER PRIMARY KEY, repr floatvector(8));";
    std::string sqlInsert = "INSERT INTO test VALUES(1, '[1.2, 0.3, 3.2, 1.6, 2.5, 3.1, 0.8, 0.4]');";
...
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_007, TestSize.Level1)
{
    ...
    EXPECT_EQ(E_OK, resultSet->Close());
    std::pair<int32_t, ValueObject> res = RdbInterfaceExecuteRdTest::store->Execute("DROP TABLE test;");
    EXPECT_EQ(E_OK, res.first);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_008, TestSize.Level1)
{
...
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_009, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_010, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_011, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_012, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_013, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_014, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_015, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_016, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_017, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
    int versionToGet = 0;
    int versionToSet = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_018, TestSize.Level1)
{
    RdbInterfaceExecuteRdTest::store = nullptr;
    ...
    EXPECT_TRUE((isOriginDbEncrypt && RdbInterfaceExecuteRdTest::store == nullptr) ||
                (!isOriginDbEncrypt && RdbInterfaceExecuteRdTest::store != nullptr));
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_019, TestSize.Level1)
{
    std::string sqlCreateTable
 ...
 * @tc.type: FUNC
*/
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_Execute_020, TestSize.Level0)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
    std::string sqlCreateTable = "CREATE TABLE IF NOT EXISTS test (id INTEGER PRIMARY KEY, repr floatvector(8));";
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, Rdb_BackupRestoreTest_001, TestSize.Level2)
{
    //create new db instance
    int errCode = E_OK;
    RdbStoreConfig config(RdbInterfaceExecuteRdTest::restoreDatabaseName);
    config.SetIsVector(true);
    ...
    int ret = store->Backup(RdbInterfaceExecuteRdTest::backupDatabaseName, encryptKey);
    EXPECT_EQ(ret, E_OK);

    res = store->Execute("delete from test where id = 1;");
    EXPECT_EQ(E_OK, res.first);

    ret = store->Restore(RdbInterfaceExecuteRdTest::backupDatabaseName, encryptKey);
    EXPECT_EQ(ret, E_OK);
    ...
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::restoreDatabaseName);
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::backupDatabaseName);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, Rdb_IsUsingArkDataTest_001, TestSize.Level2)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_BatchInsert_001, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
    std::string sqlCreateTable = "CREATE TABLE IF NOT EXISTS test (id INTEGER PRIMARY KEY, repr floatvector(8));";
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_BatchInsert_002, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_BatchInsert_003, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_RegisterAlgo_001, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_RegisterAlgo_002, TestSize.Level1)
{
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
    std::string algoName = "clst_algo_v0";
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_RegisterAlgo_003, TestSize.Level1)
{
    RdbInterfaceExecuteRdTest::store = nullptr;
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::databaseName);
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_RegisterAlgo_004, TestSize.Level1)
{
    RdbInterfaceExecuteRdTest::store = nullptr;
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::databaseName);
    ...
    std::string algoName = "clst_algo_v0";
    int ret = RdbInterfaceExecuteRdTest::store->RegisterAlgo(algoName, ClusterAlgoByEvenNumber);
    EXPECT_EQ(ret, E_NOT_SUPPORT);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_RegisterAlgo_005, TestSize.Level1)
{
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::databaseName);
    std::shared_ptr<RdbStore> &store = RdbInterfaceExecuteRdTest::store;
    std::string algoName = "clst_algo_v0";
 ...
 * @tc.type: FUNC
 */
HWTEST_P(RdbInterfaceExecuteRdTest, RdbStore_RekeyEx_001, TestSize.Level1)
{
    RdbInterfaceExecuteRdTest::store = nullptr;
    RdbHelper::DeleteRdbStore(RdbInterfaceExecuteRdTest::databaseName);
    int errCode = E_OK;
