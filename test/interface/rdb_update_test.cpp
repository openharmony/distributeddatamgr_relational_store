...
public:
    ...
    static void ExpectValue(const std::shared_ptr<OHOS::NativeRdb::ResultSet> &resultSet, const RdbRowData &expect);
    void SetUp();
    void TearDown();
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_Update_001, TestSize.Level1)
{
    ...
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 2, "lisi", 20, 200.5, std::vector<uint8_t>{ 4, 5, 6 } });
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_Update_002, TestSize.Level1)
{
    ...
    ret = resultSet->GoToNextRow();
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 1, "zhangsan", 18, 300.5, std::vector<uint8_t>{ 4, 5, 6 } });

    ret = resultSet->GoToNextRow();
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 2, "lisi", 19, 300.5, std::vector<uint8_t>{ 4, 5, 6 } });
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_Update_007, TestSize.Level1)
{
    ...
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ .id = 3,
                                                   .asset{ .version = 1,
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_Update_009, TestSize.Level1)
{
    ...
    ret = resultSet->GoToFirstRow();
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ .id = 5,
                                                   .asset{ .version = 0,
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_UpdateWithConflictResolution_001, TestSize.Level1)
{
    ...
    ret = resultSet->GoToNextRow();
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 1, "zhangsan", 18, 100.5, std::vector<uint8_t>{ 1, 2, 3 } });

    ret = resultSet->GoToNextRow();
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 3, "wangjing", 20, 300.5, std::vector<uint8_t>{ 7, 8, 9 } });
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_UpdateWithConflictResolution_002, TestSize.Level1)
{
    ...
    ret = resultSet->GoToNextRow();
    EXPECT_EQ(ret, E_OK);
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 2, "lisi", 19, 200.5, std::vector<uint8_t>{ 4, 5, 6 } });
...
HWTEST_P(RdbStoreUpdateTest, RdbStore_UpdateWithConflictResolution_006, TestSize.Level1)
{
    ...
    RdbStoreUpdateTest::ExpectValue(resultSet, RdbRowData{ 2, "zhangsan", 20, 300.5, std::vector<uint8_t>{ 4, 5, 6 } });
...
void RdbStoreUpdateTest::ExpectValue(
    const std::shared_ptr<OHOS::NativeRdb::ResultSet> &resultSet, const RdbRowData &expect)
{
