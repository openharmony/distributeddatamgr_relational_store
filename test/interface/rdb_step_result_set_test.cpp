...
void RdbInterfaceStepResultSetTest::CheckColumnType(
    std::shared_ptr<ResultSet> resultSet, int columnIndex, ColumnType type)
{
 ...
 * @tc.desc: Test basic functions of StepResultSet including GoTo, GoToFirstRow, GoToNextRow,
 *           GetRowIndex, GetRowCount, and column type checking for INTEGER, STRING, FLOAT,
 *           BLOB, ASSET, ASSETS, FLOAT32_ARRAY, and BIGINT types
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet navigation functions including GetRowIndex, GoToRow,
 *           GoToLastRow, GoToPreviousRow, and state checking (IsStarted, IsAtLastRow, IsEnded)
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet row iteration with GoToNextRow in a loop and verify
 *           position tracking and state changes during traversal
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet behavior with empty result set, verify that GoToNextRow
 *           fails and result set remains at initial position with IsEnded = true
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet GoToFirstRow function with multiple calls and verify
 *           it correctly navigates to first row and updates state flags
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet with GetInt and GetLong functions to retrieve integer
 *           and long integer values from specific columns
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet QueryByStep with readable-only parameter (false),
 *           verify GetRowCount, IsAtLastRow, and GetString operations work correctly
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet with readable-only QueryByStep (false parameter),
 *           verify complete navigation: GoToRow, GoToLastRow, GoToPreviousRow,
 *           and state checking functions
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: Test StepResultSet GetColumnType for NULL values, verify that columns
 *           containing NULL values are correctly identified as TYPE_NULL
 * @tc.type: FUNC
 */
