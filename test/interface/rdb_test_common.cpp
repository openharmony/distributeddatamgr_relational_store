...
ValuesBucket RdbTestUtils::SetRowData(const RdbRowData &rowData)
{
    ValuesBucket value;
...
const RdbRowData RdbTestUtils::g_rowData[3] = {
    {1, "zhangsan", 18, 100.5, std::vector<uint8_t>{ 1, 2, 3 }},
    {2, "lisi", 19, 200.5, std::vector<uint8_t>{ 4, 5, 6 }},
    {3, "wangyari", 20, 300.5, std::vector<uint8_t>{ 7, 8, 9 }}
};

ValuesBucket RdbTestUtils::SetRowDatas(const RdbRowDatas &rowDatas)
{
    ValuesBucket value;
