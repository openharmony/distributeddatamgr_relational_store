...
class RdbInterfaceEncryptTest : public testing::Test {
public:
...
const std::string RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME = RDB_TEST_PATH + "encrypted.db";
const std::string RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_BACKUP_NAME = RDB_TEST_PATH + "encrypted_bak.db";
const std::string RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME2 = RDB_TEST_PATH + "encrypted2.db";
const std::string RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_BACKUP_NAME2 = RDB_TEST_PATH + "encrypted2_bak.db";
const std::string RdbInterfaceEncryptTest::UNENCRYPTED_DATABASE_NAME = RDB_TEST_PATH + "unencrypted.db";

std::shared_ptr<RdbStore> RdbInterfaceEncryptTest::testStore = nullptr;
...
void RdbInterfaceEncryptTest::SetUpTestCase(void)
{
}

void RdbInterfaceEncryptTest::TearDownTestCase(void)
{
}

void RdbInterfaceEncryptTest::SetUp(void)
{
    RdbHelper::ClearCache();
    RdbHelper::DeleteRdbStore(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    RdbHelper::DeleteRdbStore(RdbInterfaceEncryptTest::UNENCRYPTED_DATABASE_NAME);
}

void RdbInterfaceEncryptTest::TearDown(void)
{
    RdbHelper::ClearCache();
    RdbHelper::DeleteRdbStore(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    RdbHelper::DeleteRdbStore(RdbInterfaceEncryptTest::UNENCRYPTED_DATABASE_NAME);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_01, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_02, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::UNENCRYPTED_DATABASE_NAME);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_03, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(true);
    ...
    int ret = store->Insert(id, "test", RdbTestUtils::SetRowData(RdbTestUtils::g_rowData[0]));
    EXPECT_EQ(ret, E_OK);
    EXPECT_EQ(1, id);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_04, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(true);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_05, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(true);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_06, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_07, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_008, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(true);
    EncryptTestOpenCallback helper;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_009, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(true);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_010, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(true);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, RdbStore_Encrypt_011, TestSize.Level1)
{
    RdbStoreConfig config(RdbInterfaceEncryptTest::UNENCRYPTED_DATABASE_NAME);
    config.SetEncryptStatus(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RdbInterfaceEncryptTest, KeyFilePath_test_001, TestSize.Level2)
{
    RdbStoreConfig config1(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME);
    ...
    RdbStoreConfig config2(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_NAME2);
    ...
    EXPECT_EQ(E_OK, store1->Backup(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_BACKUP_NAME));
    EXPECT_EQ(E_OK, store1->Restore(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_BACKUP_NAME));

    EXPECT_EQ(E_OK, store2->Backup(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_BACKUP_NAME2));
    EXPECT_EQ(E_OK, store2->Restore(RdbInterfaceEncryptTest::ENCRYPTED_DATABASE_BACKUP_NAME2));
}