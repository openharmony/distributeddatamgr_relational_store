...
| `${OHOS_ROOT}/prebuilts/clang/ohos/linux-x86_64/llvm/bin/clang-format --style=file -i <file>` | 格式化单个文件（使用仓库 `.clang-format` 配置） | `${OHOS_ROOT}` 为 OpenHarmony 源码根目录（如 `/data/home/g30051535/openHarmony/master`）；提交前 **MUST** 格式化 |
