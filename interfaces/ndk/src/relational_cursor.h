...
private:
    ...
    static int GetAsset(OH_Cursor *cursor, int32_t columnIndex, OH_Asset *value);
    static int GetAssets(OH_Cursor *cursor, int32_t columnIndex, OH_Asset **value, uint32_t *length);
