...
#define OHOS_DISTRIBUTED_DATA_INTERFACE_GDB_GDB_ERRORS_H
...
constexpr int E_GRD_INVALID_NAME = (E_BASE + 0xb);
...
#endif // OHOS_DISTRIBUTED_DATA_INTERFACE_GDB_GDB_ERRORS_H