...
struct SqlInfo {
    std::string sql;
    std::vector<NativeRdb::ValueObject> valueObjectArray;
};
...
public:
    ...
    static std::pair<int, SqlInfo> GetUpdateSqlInfo(const std::string &table, const Row &row, const std::string &where,
