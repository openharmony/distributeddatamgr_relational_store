...
/**
 * The ResultSet class of RDB.
 * Provides methods for accessing a database result set generated by querying the database.
 */
class RDB_API_EXPORT ResultSet {
public:
    /**
     * @brief The error CMD in the correct case.
     */
    enum {
        /** Indicates the current error CMD is CMD_GET_ALL_COLUMN_NAMES.*/
        CMD_GET_ALL_COLUMN_NAMES,
        /** Indicates the current error CMD is CMD_GET_COLUMN_COUNT.*/
        CMD_GET_COLUMN_COUNT,
        /** Indicates the current error CMD is CMD_GET_COLUMN_TYPE.*/
        CMD_GET_COLUMN_TYPE,
        /** Indicates the current error CMD is CMD_GET_COLUMN_INDEX.*/
        CMD_GET_COLUMN_INDEX,
        /** Indicates the current error CMD is CMD_GET_COLUMN_NAME.*/
        CMD_GET_COLUMN_NAME,
        /** Indicates the current error CMD is CMD_GET_ROW_COUNT.*/
        CMD_GET_ROW_COUNT,
        /** Indicates the current error CMD is CMD_GET_ROW_INDEX.*/
        CMD_GET_ROW_INDEX,
        /** Indicates the current error CMD is CMD_GO_TO.*/
        CMD_GO_TO,
        /** Indicates the current error CMD is CMD_GO_TO_ROW.*/
        CMD_GO_TO_ROW,
        /** Indicates the current error CMD is CMD_GO_TO_FIRST_ROW.*/
        CMD_GO_TO_FIRST_ROW,
        /** Indicates the current error CMD is CMD_GO_TO_LAST_ROW.*/
        CMD_GO_TO_LAST_ROW,
        /** Indicates the current error CMD is CMD_GO_TO_NEXT_ROW.*/
        CMD_GO_TO_NEXT_ROW,
        /** Indicates the current error CMD is CMD_GO_TO_PREV_ROW.*/
        CMD_GO_TO_PREV_ROW,
        /** Indicates the current error CMD is CMD_IS_ENDED_ROW.*/
        CMD_IS_ENDED_ROW,
        /** Indicates the current error CMD is CMD_IS_STARTED_ROW.*/
        CMD_IS_STARTED_ROW,
        /** Indicates the current error CMD is CMD_IS_AT_FIRST_ROW.*/
        CMD_IS_AT_FIRST_ROW,
        /** Indicates the current error CMD is CMD_IS_AT_LAST_ROW.*/
        CMD_IS_AT_LAST_ROW,
        /** Indicates the current error CMD is CMD_GET_BLOB.*/
        CMD_GET_BLOB,
        /** Indicates the current error CMD is CMD_GET_STRING.*/
        CMD_GET_STRING,
        /** Indicates the current error CMD is CMD_GET_INT.*/
        CMD_GET_INT,
        /** Indicates the current error CMD is CMD_GET_LONG.*/
        CMD_GET_LONG,
        ...
        CMD_CLOSE,
        /** Indicates the current error CMD is CMD_MAX.*/
        CMD_MAX
    };
