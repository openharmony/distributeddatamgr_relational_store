...
public:
    ...
    RDB_API_EXPORT ValueObject Get(const std::string &name) const;
    RDB_API_EXPORT ValueObject Get(const int index) const;
    RDB_API_EXPORT void Get(std::map<std::string, ValueObject> &outValues) const;
 ...
 */
class RDB_API_EXPORT ResultSet : public RemoteResultSet {
public:
    /**
     * @brief Destructor.
     */
