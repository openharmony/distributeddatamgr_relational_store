...
#ifndef DSOFTBUS_INTERFACE_H
#define DSOFTBUS_INTERFACE_H
...
enum SoftBusErrNo {
    ...
    SOFTBUS_CONN_KERNELS_BASE = SOFTBUS_ERRNO(KERNELS_SUB_MODULE_CODE),
