...
enum AbilityProfileType : uint32_t { ABILITY_PROFILE = 0, EXTENSION_PROFILE = 1, UNKNOWN_PROFILE = 2 };

enum ShortcutSourceType : int32_t { DEFAULT_SHORTCUT = 0, STATIC_SHORTCUT = 1, DYNAMIC_SHORTCUT = 2 };
