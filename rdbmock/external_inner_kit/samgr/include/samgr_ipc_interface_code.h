...
#ifndef INTERFACES_INNERKITS_SAMGR_INCLUDE_SAMGR_INTERFACE_CODE_H
#define INTERFACES_INNERKITS_SAMGR_INCLUDE_SAMGR_INTERFACE_CODE_H
...
enum class SamgrInterfaceCode : uint32_t {
    ...
    GET_COMMON_EVENT_EXTRA_ID_LIST_TRANSCATION = 36,
    GET_LOCAL_ABILITY_MANAGER_PROXY_TRANSCATION = 37,
    UNLOAD_IDLE_PROCESS_BYLIST = 38,
    GET_LRU_IDLE_SYSTEM_ABILITY_PROCESS_TRANSACTION = 39,
    SET_SAMGR_IPC_PRIOR_TRANSACTION = 40,
    SUBSCRIBE_LOWMEM_SYSTEM_PROCESS_TRANSACTION = 41,
    UNSUBSCRIBE_LOWMEM_SYSTEM_PROCESS_TRANSACTION = 42,
    ONSTART_SYSTEM_ABILITY_FAIL_TRANSACTION = 43,
    ON_USER_STATE_CHANGED_TRANSACTION = 44,
};
} // namespace OHOS
#endif // !defined(INTERFACES_INNERKITS_SAMGR_INCLUDE_SAMGR_INTERFACE_CODE_H)