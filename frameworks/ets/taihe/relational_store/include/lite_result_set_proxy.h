...
#ifndef OHOS_RELATION_STORE_LITE_RESULT_SET_PROXY_H
#define OHOS_RELATION_STORE_LITE_RESULT_SET_PROXY_H
...
public:
    ...
    explicit LiteResultSetProxy(std::shared_ptr<OHOS::NativeRdb::ResultSet> resultSet);
    LiteResultSetProxy& operator=(std::shared_ptr<OHOS::NativeRdb::ResultSet> resultSet);
...
#endif // OHOS_RELATION_STORE_LITE_RESULT_SET_PROXY_H