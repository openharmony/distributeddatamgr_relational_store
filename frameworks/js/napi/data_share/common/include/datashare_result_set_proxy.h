...
public:
    ...
    DataShareResultSetProxy(std::shared_ptr<DataShareResultSet> resultSet);
...
napi_value GetNapiResultSetObject(napi_env env, OHOS::DataShare::DataShareResultSet *resultSet);
