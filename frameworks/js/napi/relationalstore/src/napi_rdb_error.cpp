...
static constexpr JsErrorCode JS_ERROR_CODE_MSGS[] = {
    ...
    { NativeRdb::E_INVALID_FILE_PATH, 14800010, "Failed to open or delete database by invalid database path." },
    ...
    { NativeRdb::E_ALREADY_CLOSED, 14800014, "The close method of RdbStore or ResultSet has been called." },
    ...
    { NativeRdb::E_NOT_SUPPORT_THE_SQL, 14800021, "SQLite: Generic error. Executed sql is not support." },
    { NativeRdb::E_ATTACHED_DATABASE_EXIST, 14800016, "The database alias already exists." },
    { NativeRdb::E_SQLITE_ERROR, 14800021, "SQLite: Generic error. Possible causes: Insert or update data not exist." },
    { NativeRdb::E_SQLITE_CORRUPT, 14800011, "Database corrupted. The database file is damaged and incomplete." },
    ...
    { NativeRdb::E_CONFIG_INVALID_CHANGE, 14800017, "Configuration of StoreConfig has changed." },
