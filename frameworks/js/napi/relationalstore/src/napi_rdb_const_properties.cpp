...
static napi_value ExportConflictResolution(napi_env env)
{
    ...
    (void) SetNamedProperty(env, conflictResolution, "ON_CONFLICT_NONE",
                            (int32_t)NativeRdb::ConflictResolution::ON_CONFLICT_NONE);
    ...
    (void) SetNamedProperty(env, conflictResolution, "ON_CONFLICT_ABORT",
                            (int32_t)NativeRdb::ConflictResolution::ON_CONFLICT_ABORT);
    (void) SetNamedProperty(env, conflictResolution, "ON_CONFLICT_FAIL",
                            (int32_t)NativeRdb::ConflictResolution::ON_CONFLICT_FAIL);
    (void) SetNamedProperty(env, conflictResolution, "ON_CONFLICT_IGNORE",
                            (int32_t)NativeRdb::ConflictResolution::ON_CONFLICT_IGNORE);
    (void) SetNamedProperty(env, conflictResolution, "ON_CONFLICT_REPLACE",
                            (int32_t)NativeRdb::ConflictResolution::ON_CONFLICT_REPLACE);
