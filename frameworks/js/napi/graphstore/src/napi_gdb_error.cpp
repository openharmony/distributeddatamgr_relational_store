...
static constexpr JsErrorCode JS_ERROR_CODE_MSGS[] = {
    ...
    { E_GRD_DUPLICATE_PARAM, 31300006, "Duplicate type or properties name of vertex and edge." },
    { E_GRD_UNDEFINED_PARAM, 31300007, "The type or properties of vertex and edge is not defined." },
