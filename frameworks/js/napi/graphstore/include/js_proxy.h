...
#ifndef OHOS_DISTRIBUTED_DATA_GDB_JS_NAPI_JS_PROXY_H
#define OHOS_DISTRIBUTED_DATA_GDB_JS_NAPI_JS_PROXY_H
#include <memory>
...
#endif // OHOS_DISTRIBUTED_DATA_GDB_JS_NAPI_JS_PROXY_H
