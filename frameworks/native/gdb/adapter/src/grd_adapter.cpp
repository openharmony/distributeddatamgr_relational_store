...
std::map<int32_t, int32_t> GrdAdapter::GRD_ERRNO_MAP = {
    ...
    { GRD_PRIMARY_KEY_VIOLATION, E_GRD_CONSTRAINT_CHECK_VIOLATION },
    { GRD_RESTRICT_VIOLATION, E_GRD_CONSTRAINT_CHECK_VIOLATION },
    ...
    { GRD_NAME_TOO_LONG, E_GRD_DATA_CONFLICT },
    ...
    { GRD_SUBSCRIPTION_EXCEEDED_LIMIT, E_GRD_DATA_CONFLICT },
    { GRD_SYNC_EXCEED_TASK_QUEUE_LIMIT, E_GRD_DATA_CONFLICT },
    { GRD_SHARED_OBJ_ENABLE_UNDO_EXCEED_LIMIT, E_GRD_DATA_CONFLICT },
    { GRD_TABLE_LIMIT_EXCEEDED, E_GRD_DATA_CONFLICT },
...
int32_t GrdAdapter::Finalize(GRD_StmtT *stmt)
{
    ...
    LOG_DEBUG("Finalize ret=%{public}d", ret);
    return TransErrno(ret);
}
...
int32_t GrdAdapter::Step(GRD_StmtT *stmt)
{
    ...
    LOG_DEBUG("Step ret=%{public}d", ret);
    return TransErrno(ret);
}
