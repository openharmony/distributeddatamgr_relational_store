...
#ifndef NATIVE_RDB_ABS_SHARED_RESULT_SET_CLIENT_H
#define NATIVE_RDB_ABS_SHARED_RESULT_SET_CLIENT_H

#include "abs_shared_result_set.h"
#include "iresult_set.h"

namespace OHOS::NativeRdb {
class AbsSharedResultSetClient : public AbsSharedResultSet {
public:
    explicit AbsSharedResultSetClient(sptr<IResultSet> &resultSetProxy);
    ~AbsSharedResultSetClient() override;
...
private:
    sptr<IResultSet> resultSetProxy_;
};
} // namespace OHOS::NativeRdb
#endif // NATIVE_RDB_ABS_SHARED_RESULT_SET_CLIENT_H
