...
DataSharePredicatesObject::DataSharePredicatesObject(const std::string &val) : type(DataSharePredicatesObjectType::TYPE_STRING)
{
    value = val;
}

DataSharePredicatesObject::DataSharePredicatesObject(const std::vector<int> &val) : type(DataSharePredicatesObjectType::TYPE_INT_VECTOR)
{
...
DataSharePredicatesObject::DataSharePredicatesObject(const std::vector<int64_t> &val) : type(DataSharePredicatesObjectType::TYPE_LONG_VECTOR)
{
    std::vector<int64_t> parameter = val;
    value = parameter;
}

DataSharePredicatesObject::DataSharePredicatesObject(const std::vector<std::string> &val) : type(DataSharePredicatesObjectType::TYPE_STRING_VECTOR)
{
    std::vector<std::string> parameter = val;
    value = parameter;
}

DataSharePredicatesObject::DataSharePredicatesObject(const std::vector<double> &val) : type(DataSharePredicatesObjectType::TYPE_DOUBLE_VECTOR)
{
    std::vector<double> parameter = val;
    value = parameter;
}

DataSharePredicatesObject &DataSharePredicatesObject::operator=(DataSharePredicatesObject &&DataSharePredicatesObject) noexcept
{
    if (this == &DataSharePredicatesObject) {
        return *this;
    }
...
DataSharePredicatesObject &DataSharePredicatesObject::operator=(const DataSharePredicatesObject &DataSharePredicatesObject)
{
    if (this == &DataSharePredicatesObject) {
        return *this;
    }
...
DataSharePredicatesObject *DataSharePredicatesObject::Unmarshalling(Parcel &parcel)
{
    ...
    switch (parcel.ReadInt16()) {
        case (int16_t)DataSharePredicatesObjectType::TYPE_NULL: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_NULL;
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_INT: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_INT;
            pValueObject->value = static_cast<int>(parcel.ReadInt64());
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_LONG: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_LONG;
            pValueObject->value = parcel.ReadInt64();
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_DOUBLE: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_DOUBLE;
            pValueObject->value = parcel.ReadDouble();
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_STRING: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_STRING;
            pValueObject->value = parcel.ReadString();
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_BOOL: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_BOOL;
            pValueObject->value = parcel.ReadBool();
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_INT_VECTOR: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_INT_VECTOR;
            std::vector<int64_t> int64val{};
        ...
        case (int16_t)DataSharePredicatesObjectType::TYPE_LONG_VECTOR: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_LONG_VECTOR;
            std::vector<int64_t> int64val{};
            parcel.ReadInt64Vector(&int64val);
            pValueObject->value = int64val;
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_DOUBLE_VECTOR: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_DOUBLE_VECTOR;
            std::vector<double> doubleval{};
            parcel.ReadDoubleVector(&doubleval);
            pValueObject->value = doubleval;
            break;
        }
        case (int16_t)DataSharePredicatesObjectType::TYPE_STRING_VECTOR: {
            pValueObject->type = DataSharePredicatesObjectType::TYPE_STRING_VECTOR;
