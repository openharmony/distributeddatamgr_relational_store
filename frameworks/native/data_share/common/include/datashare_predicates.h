...
public:
    DataSharePredicates();
    DataSharePredicates(std::list<OperationItem> &operationList);
    ~DataSharePredicates();
    ...
    DataSharePredicates *Limit(int value)override;
...
private:
    void SetOperationList(OperationType operationType, DataSharePredicatesObject &para1, DataSharePredicatesObject &para2,
                          DataSharePredicatesObject &para3, ParameterCount parameterCount);
};
} // namespace DataShare
} // namespace OHOS
